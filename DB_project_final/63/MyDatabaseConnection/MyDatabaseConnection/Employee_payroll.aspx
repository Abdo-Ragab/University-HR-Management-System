<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee_payroll.aspx.cs" Inherits="MyDatabaseConnection.Employee_payroll" %>
        ...
        ">
            ...
            <asp:Button ID="Process" runat="server"
                ...
                Style="font-size:18px; padding:10px 20px;
                       ...
                       border:none; border-radius:6px; width:250px;" />
