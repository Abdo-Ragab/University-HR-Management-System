<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HR_DeductDays.aspx.cs" Inherits="MyDatabaseConnection.HR_DeductDays" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Deduct Days</title>
</head>
...
<body style="background-color: #0A3D62;">
    ...
    <form id="form1" runat="server">
        ...
        ">
            ...
            <asp:TextBox ID="empid1" runat="server" 
                Style="font-size:18px; width:200px;" />

            <br /><br />

            <asp:Button ID="Process4" runat="server" Text="Process" OnClick="Process"
